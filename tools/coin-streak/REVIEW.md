...
Flips a virtual coin a hundred times on each click and reports the longest
unbroken run of heads. One loop, one counter, one comparison; the whole tool is
...
any policy the file declared for itself removed. 584 bytes in, 732 out.
